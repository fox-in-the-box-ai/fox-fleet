...
// Spec: fox-in-the-box/docs/architecture/ENTERPRISE_ARCHITECTURE.md section 6.4 (8 checks)
//       fox-in-the-box/docs/architecture/FLEET_BASE_V01_SPEC.md section 1 (provisioning timeout = 120s)
// Milestone: v0.1
package plugin
