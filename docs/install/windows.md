...
A Windows binary (`fox-control-v1.0.0-windows-amd64.tar.gz`) is
available from [GitHub Releases](https://github.com/fox-in-the-box-ai/fox-fleet/releases).

```powershell
# Extract
tar xzf fox-control-v1.0.0-windows-amd64.tar.gz

# Run
.\fox-control-v1.0.0-windows-amd64\fox-control.exe version
```
