...
```bash
# amd64
curl -fsSLO https://github.com/fox-in-the-box-ai/fox-fleet/releases/download/v1.5.0/fox-control_1.5.0_amd64.deb
sudo dpkg -i fox-control_1.5.0_amd64.deb

# arm64
curl -fsSLO https://github.com/fox-in-the-box-ai/fox-fleet/releases/download/v1.5.0/fox-control_1.5.0_arm64.deb
sudo dpkg -i fox-control_1.5.0_arm64.deb
```
...
| Architecture | File |
|-------------|------|
| x86_64 (amd64) | `fox-control-v1.5.0-linux-amd64.tar.gz` |
| ARM64 (aarch64) | `fox-control-v1.5.0-linux-arm64.tar.gz` |

```bash
tar xzf fox-control-v1.5.0-linux-amd64.tar.gz
sudo install -m 755 fox-control-v1.5.0-linux-amd64/fox-control /usr/local/bin/
```
...
gh release download v1.5.0 --repo fox-in-the-box-ai/fox-fleet \
  --pattern 'fox-control-v1.5.0-linux-amd64.tar.gz*'
