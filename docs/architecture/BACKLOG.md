...
| DP-01 | Embedding client retry with backoff | S | v1.3.0 | Shipped |
| DP-02 | Per-operation Qdrant client timeouts | S | v1.3.0 | Shipped |
| DP-03 | Qdrant health monitoring | S | v1.3.0 | Shipped |
| DP-04 | Incremental source re-ingestion | M | v1.3.0 | Shipped |
| DP-05 | Data plane WriteTimeout and body limits | XS | v1.1.0 | Shipped |
| DP-06 | Qdrant upsert batching | S | v1.3.0 | Shipped |
| DP-07 | Source deletion cascade | S | v1.3.0 | Shipped |
| DP-08 | Embedding dimension validation | S | v1.3.0 | Shipped |
| DP-09 | Query result score threshold filtering | S | v1.3.0 | Shipped |
| INT-01 | Webhook event forwarding (HMAC-SHA256) | M | v1.2.0 | Shipped |
| INT-02 | Structured JSON logging | S | v1.2.0 | Shipped |
| PLAT-01 | Runtime skillset tool validation | S | v1.3.0 | Shipped |
| PLAT-02 | Graceful shutdown with request draining | S | v1.1.0 | Shipped |
| PLAT-03 | Health-check-based auto-restart | M | v1.3.0 | Shipped |
| PLAT-04 | Registry migration versioning | S | v1.1.0 | Shipped |
| CONF-01 | Data plane conformance checks | M | v1.3.0 | Shipped |
| CONF-02 | Security conformance checks | S | v1.3.0 | Shipped |
