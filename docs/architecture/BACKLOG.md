...
| OPS-06 | Diagnostics command | M | v1.2.0 | Backlog |
...
| REL-02 | Automated dependency updates (Dependabot) | S | v1.2.0 | Backlog |
...
| PERF-01 | ValidQueryToken hash-then-lookup optimization | XS | v1.2.0 | Backlog |
...
| POLISH-02 | CLI --output flag (table/json/quiet) | S | v1.2.0 | Backlog |
