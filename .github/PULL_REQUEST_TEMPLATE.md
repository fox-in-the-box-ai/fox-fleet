...
- [ ] No secrets in code, logs, comments, or transcripts (Rule 6)
- [ ] Browser-facing changes verified in a real browser, not just curl (Rule 7)
- [ ] Fresh-deploy path tested for release-tagged PRs (Rule 8)
