...
func (s *Server) handleQuery(w http.ResponseWriter, r *http.Request) {
	if s.dpURL == "" {
		writeError(w, http.StatusServiceUnavailable, "no_data_plane", "data plane is not configured")
		return
	}
	...
	if err != nil {
		writeError(w, http.StatusInternalServerError, "internal_error", "failed to create proxy request")
		return
	}
	...
	if err != nil {
		writeError(w, http.StatusBadGateway, "data_plane_error", "failed to reach data plane")
		return
	}
