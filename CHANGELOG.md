...
- **REL-03:** SBOM generation — CycloneDX JSON SBOM for each release (Go module dependencies), signed with cosign; container image SBOM attached via `cosign attach sbom`
